...
class RecipeApp(object):
    ...
    def __init__(self):  # Fixed constructor name
        ...
        self.window.configure(bg="#FF69B4")
        self.window.title(WINDOW_TITLE)

        self.search_label = tk.Label(self.window, text="Search Recipe", bg="#00BFFF")
    ...
    def __run_search_query(self):
        ...
        self.recipe_button = tk.Button(self.window, text="recipe link", highlightbackground="#FFFFFF",
                                       command=__open_link)
